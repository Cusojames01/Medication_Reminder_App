        ...
        <ScrollView style={styles.modalContainer}>
          ...
          <View style={styles.personalHeader}>
            ...
            <View style={{ marginLeft: 15 }}>
              ...
              {user.role === "Patient" && (
                <Text style={styles.patientID}>Patient ID: {user.patientID}</Text>
              )}
            </View>
          </View>
         ...
         <View style={styles.detailRow}>
            ...
            {isEditing ? (
              <TextInput
                style={styles.input}
                value={editUser.  medical_condition}
                onChangeText={(text) => setEditUser({ ...editUser,   medical_condition: text })}
              />
            ) : (
              <Text style={styles.valueText}>{editUser.  medical_condition}</Text>
            )}
          </View>
